...
viewTemplate = {
    ...
    "blocks": [
        ...
        {
            "type": "section",
            "text": {"type": "mrkdwn", "text": "Choose article you want"},
            "accessory": {
                "type": "static_select",
                "placeholder": {
                    "type": "plain_text",
                ...
                "options": [
                    {
                        "text": {"type": "plain_text", "text": "Qiita", "emoji": True},
                        "value": "qiita",
                    },
                    {
                        "text": {"type": "plain_text", "text": "Zenn", "emoji": True},
                        "value": "zenn",
                    },
                    {
                        "text": {
                    ...
                    {
                        "text": {"type": "plain_text", "text": "yahoo", "emoji": True},
                        "value": "yahoo",
                    },
                    {
                        "text": {"type": "plain_text", "text": "技術評論社", "emoji": True},
                        "value": "gihyo",
                    },
                    {
                        "text": {"type": "plain_text", "text": "pfn", "emoji": True},
                        "value": "pfn",
                    },
                    {
                        "text": {
                    ...
                    {
                        "text": {"type": "plain_text", "text": "AWS", "emoji": True},
                        "value": "aws",
                    },
                    {
                        "text": {
                    ...
                    {
                        "text": {"type": "plain_text", "text": "infoq", "emoji": True},
                        "value": "infoq",
                    },
                    {
                        "text": {
        ...
        {"type": "divider"},
        {"type": "section", "text": {"type": "mrkdwn", "text": "This is Home"}},
    ],
}
...
def update_home_tab(client, event, logger):
    ...
    client.views_publish(user_id=event["user"], view=viewTemplate)
...
def approve_request(ack, body, client, say, message, event, payload):
    ...
    if query == "qiita":
        ...
        viewTemplate["blocks"][-1]["text"]["text"] = get_rss_hacker_news(
                    ...
                    if j > 0:
                        if (
                            ...
                            split_list.append(
                                {
                                    "type": "section",
                                    "text": {"type": "mrkdwn", "text": split_text[j]},
                                }
                            )
    ...
    client.views_publish(user_id=body["user"]["id"], view=viewTemplate)
